...
public class FileSearchProvider implements SearchProvider {
    ...
    public List<SearchResultDto> search(String query, String workspacePublicId, Long userId, Pageable pageable) {
        return searchRepository.searchFiles(query, workspacePublicId, userId, pageable.getPageSize() + 1, (int) pageable.getOffset());
    }
}
