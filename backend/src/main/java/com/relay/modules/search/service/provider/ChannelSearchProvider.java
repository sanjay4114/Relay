...
public class ChannelSearchProvider implements SearchProvider {
    ...
    public List<SearchResultDto> search(String query, String workspacePublicId, Long userId, Pageable pageable) {
        return searchRepository.searchChannels(query, workspacePublicId, userId, pageable.getPageSize() + 1, (int) pageable.getOffset());
    }
}
