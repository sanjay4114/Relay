...
public class MessageSearchProvider implements SearchProvider {
    ...
    public List<SearchResultDto> search(String query, String workspacePublicId, Long userId, Pageable pageable) {
        return searchRepository.searchMessages(query, workspacePublicId, userId, pageable.getPageSize() + 1, (int) pageable.getOffset());
    }
}
